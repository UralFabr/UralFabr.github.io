...
<!-- /Yandex.Metrika counter -->
 <script src="UralFabr.github.io/jquery-3.2.1.min.js"></script>
  <link href="UralFabr.github.io/magnific-popup.css" rel="stylesheet">
<link rel="shortcut icon" href="UralFabr.github.io/img/el.ico">
  <link rel="stylesheet" type="text/css" href="UralFabr.github.io/tetst1.css"/> 
 <style type="text/css">
   header {
...
setTimeout('startTime()',7000);
             ...
             </font></div><font face="Golos Text_DemiBold.ttf"><a href="https://vk.com/kirillmalad0i">
     </a><a href="https://uralfabr.github.io/support.html">   <div class="top-left">ЧаВо</div></a>
    </div>
  ...
  <img src="https://github.com/UralFabr/UralFabr.github.io/blob/main/img/home/1.jpg?raw=true" alt="Кнопка «button»" width="70px" height="55px">
   ...
   <div class="top-left5">+4</div>
      <img src="https://github.com/UralFabr/UralFabr.github.io/blob/main/img/home/2.jpg?raw=true" alt="Кнопка «button»" width="124px" height="55px" vspace="4px">
  </button>  
   <script>
         $('#open-popup').magnificPopup({
    items: [
      {
        src: 'https://github.com/UralFabr/UralFabr.github.io/blob/main/img/home/1.jpg?raw=true',
        title: ' '
      },
     {
        src: 'https://github.com/UralFabr/UralFabr.github.io/blob/main/img/home/2.jpg?raw=true',
        title: ' '
      },
     {
        src: 'https://github.com/UralFabr/UralFabr.github.io/blob/main/img/home/3.jpg?raw=true',
        title: ''
      },
     {
        src: 'https://github.com/UralFabr/UralFabr.github.io/blob/main/img/home/4.jpg?raw=true',
        title: ' '
      },
     {
        src: 'https://github.com/UralFabr/UralFabr.github.io/blob/main/img/home/5.jpg?raw=true',
        title: ''
      },
     {
        src: 'https://github.com/UralFabr/UralFabr.github.io/blob/main/img/home/6.jpg?raw=true',
        title: ' '
      },
  ...
  <img src="https://avatanplus.com/files/effects/original/583eb65914425158b4f84bfb.jpg" alt="Кнопка «button»" width="124px" height="60px">
   ...
   <script>
    ...
    items: [
      {
        src: 'https://sun9-41.userapi.com/impg/HdqNGjrFuDL3pIQ59RYL5vo8ufaTM0DWXor3gw/71l-TnGIoD8.jpg?size=656x1080&quality=96&sign=d53155649c1ec3bc4391cf56cc8a9a6b&type=album',
        title: 'Валя круглишь '
      },
     {
        src: 'https://github.com/UralFabr/UralFabr.github.io/blob/main/img/hJ-n9Z7aazg.jpg?raw=true',
        title: 'Валя круглишь '
      },
      {
      ...
      {
        src: $('<div class="white-popup">Назад</div>'), // Dynamically created element
        type: 'inline'
      },
...
<div class="mySlides fade">
 ...
 <a href="https://vk.com/vkedah666">
  <img src="https://github.com/UralFabr/UralFabr.github.io/blob/main/img/lNpEn5YFEfc.jpg?raw=true" style="width:100%">
  </a>
</div>

<div class="mySlides fade">
  <div class="numbertext"></div>
 <a href="https://vk.com/kurushinvalentin">
  <img src="https://github.com/UralFabr/UralFabr.github.io/blob/main/img/hJ-n9Z7aazg.jpg?raw=true" style="width:100%">
 </a>
</div>
...
function showSlides() {
  ...
  <div class="polosa">
    ...
    <div class="osn">
     <p><h1>Новости</h1></p> 
             <font face="Verdana"> 
<p >Разыскивается опасный мутант. Если вам известно местонахождение этого мутанта просьба сообщить по номеру 8 800 555 35 35 </p>
  <img src="UralFabr.github.io/img/hJ-n9Z7aazg.jpg"  alt="Antonovka"
     ...
     <div class="right1">
      ...
      <div>
        <div class="container">
            <font face="Golos Text_DemiBold.ttf"> 
      <a href="#">
      <img src="UralFabr.github.io/img/r_1.png" alt="doban"
     ...
     <div>
       <div class="container">
           <font face="Golos Text_DemiBold.ttf"> 
      <a href="#">
      <img src="UralFabr.github.io/img/r_2.png" alt="Antonovka"
          width="320" height="100"  vspace="3px"> </a>
     ...
     <div>
      <div class="container">
          <font face="Golos Text_DemiBold.ttf"> 
      <a href="#">
      <img src="UralFabr.github.io/img/r_3.png" alt="goose"
          width="320" height="100" vspace="3px" > </a>
